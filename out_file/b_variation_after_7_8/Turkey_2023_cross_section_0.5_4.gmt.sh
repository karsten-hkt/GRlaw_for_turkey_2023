gmt begin ../out_file/b_variation_after_7_8/Turkey_2023_cross_section_0.5_4.gmt png,pdf
gmt makecpt -Cjet -T0.4/1.7/0.1 -Ic -H> ../out_file/b_variation_after_7_8/Turkey_2023_cross_section_0.5_.cpt
gmt plot ../out_file/b_variation_after_7_8/Turkey_2023_cross_section_0.5_4.gmt -R-100.000000/170.000000/0.000000/25.000000 -JX5i/-0.462963i -C../out_file/b_variation_after_7_8/Turkey_2023_cross_section_0.5_.cpt -W0.01p,white -L -BENws         -Bxaf+l"Distance to Epicenter(km)" -Byaf+l"Dep(km)" --FONT_LABEL=8p,Helvetica,black
