gmt begin turkey_buffer_aftershocks_in png,pdf
	...
	awk -F, '{print $3,$4,$5,$6/20}' aftershocks_in_buffer_0.csv | gmt plot -Sc -W0.05 -C../../gmt_draw_research_area/quake_depth.cpt
